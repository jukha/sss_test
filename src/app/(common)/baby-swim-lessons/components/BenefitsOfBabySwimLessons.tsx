import { reasonToStartBabySwimLesson } from '@/assets';
import {
  LearningIcon,
  MessagingIcon,
  MuscleIcon,
...
const sellingPointsSectionData: SellingPointsSectionType = {
  sectionTitle: '5 reasons to start baby swim lessons now',
  sectionDescription:
    'Many parents wonder if their baby is too young to start learning to swim.They think babies will eventually learn the skills on their own, or that the skill isn’t necessary. Here’s why starting baby swim lessons now is a smart choice:',
  sectionTitleMaxWidth: 'max-w-[837px]',
  image: reasonToStartBabySwimLesson,
  arrowButtonProps: {
...
const BenefitsOfBabySwimLessons = () => {
  return <SellingPointsSection {...sellingPointsSectionData} />;
};

export default BenefitsOfBabySwimLessons;
