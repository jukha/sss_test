import { babySwimLessonHeroDesktop, babySwimLessonHeroMobile } from '@/assets';
...
const heroSection = {
  title: 'Babies Swim Lessons Program',
  titleHighlight: '',
  desc: 'Sunsational Swim School is America’s largest mobile swim school, offering private, at-home swim lessons for all ages.  (from ages 6 Months+)',
};

const BabySwimHero = () => {
  return (
    <Hero
      desktopBgImage={babySwimLessonHeroDesktop}
      mobileBgImage={babySwimLessonHeroMobile}
      hasBottomBar={false}
    >
      <Typography
        variant='h1'
