...
const WhyChooseUsForBabySection = () => {
  return (
    <FeatureSection
      ...
      className='pb-8'
    >
      <Container className='relative z-[2] overflow-x-clip'>
        <Typography
          variant='h2'
        ...
        <div className='absolute hidden lg:block right-[-0%] top-[-10%] w-[500px h-[500px]]'>
          <ThreeStars color='var(--color-yellow)' />
        </div>
      </Container>
...
export default WhyChooseUsForBabySection;
