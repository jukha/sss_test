...
import { whatMakesUsSunsationalFeatureImage } from '@/assets';
import Typography from '@/components/semantics/Typography';

const InstructorQualitiesSection = () => {
  const instructorQualities = {
    title: 'What makes our Swim instructors Sunsational',
    qualities: [
      {
        image: <ZoomOutIcon />,
        headerTextColor: 'var(--color-darkBlue)',
    ...
    <Container>
      <div className='pt-28'>
        ...
        {instructorQualities.qualities.map((reason, idx) => (
          <div key={idx} className='flex gap-8 items-start mb-10 pr-10 lg:pr-0'>
            {/* Icons for desktop */}
