...
export const metadata = {
  title: {
    default: 'Sunsational Swim School | At-Home Private Swim Lessons',
    template: '%s | Sunsational Swim School',
  },
  description:
    'Convenient at-home private swimming lessons with guaranteed results. Certified, background-checked instructors for all ages. Learn to swim safely and effectively.',
  keywords: [
  ...
  return (
    <main className='flex flex-col gap-20 lg:gap-26'>
      ...
      <ServerCustomerReviewsSection
        buttonText={'See our glowing reviews'}
