...
const content = {
  sectionHeading: 'Featured swim instructors in [city]',
  sectionDescripton:
    'We believe our students deserve the best, which is why our every Sunsational swim teacher has a minimum of 2 years teaching experience, is CPR/First Aid certified, passes a national background check, and has a proven track record of successful teaching before they even land an interview with Sunsational.\n\n If you believe that you have what it takes to be a Sunsational Swim Instructor, apply below:',
...
const FeaturedSwimInstructorJobSection = () => {
  return (
    <FeaturedSwimInstructorsSection
      sectionHeading={content.sectionHeading}
      sectionDescripton={content.sectionDescripton}
...
export default FeaturedSwimInstructorJobSection;
