  ...
  sellingReasons: [
    {
      ...
      description:
        'One-on-one private lessons help swimmers progress more quickly than group classes.',
    ...
    },
    {
      ...
      description:
        'No driving, no waiting—just personalized lessons at your convenience.',
      icon: <PlannerV2Icon />,
    ...
    },
    {
      ...
      description:
        'Background-checked, experienced, and CPR-certified professionals.',
      icon: <UserMaleIcon />,
