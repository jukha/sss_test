import { kidsSwimLessonWhyChooseUs } from '@/assets';
import {
  LearningIcon,
  MessagingIcon,
  MuscleIcon,
...
const sellingPointsSectionData: SellingPointsSectionType = {
  ...
  image: kidsSwimLessonWhyChooseUs,
  arrowButtonProps: { buttonClasses: 'hidden', text: '' },
...
const WhyChooseUsForKidsLessonSection = () => {
  return <SellingPointsSection {...sellingPointsSectionData} />;
};

export default WhyChooseUsForKidsLessonSection;
