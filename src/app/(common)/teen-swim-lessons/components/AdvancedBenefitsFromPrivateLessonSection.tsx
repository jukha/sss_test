...
import { advancedBenefitsFromPrivateSwimLessonImg } from '@/assets';
...
const AdvancedBenefitsFromPrivateLessonSection = () => {
  return (
    <FeatureSection
      ...
      <Container className='flex flex-col justify-start overflow-x-clip items-center relative gap-8 max-lg:py-20'>
        ...
        >
          <div className='relative flex justify-center  overflow-x-clip items-center w-full'>
            <Image
              src={advancedBenefitsFromPrivateSwimLessonImg}
...
export default AdvancedBenefitsFromPrivateLessonSection;
