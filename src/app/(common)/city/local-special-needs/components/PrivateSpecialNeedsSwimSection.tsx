...
const generalFirstSectionData: GeneralFirstSectionType = {
  heading1: 'Private special needs swim lessons in [city, state]!',
  media: privateSpecialNeedsImg,
  buttonLink: '/',
  buttonText: 'Get Started',
  buttonType: 'black',
  descriptionTop:
    'When raising a child with special needs, learning to swim can feel like another hurdle – but it’s one that can be overcome. At Sunsational Swim School, we’re proud to offer special needs swim lessons near you in [city]. Our experienced instructors teach one-on-one lessons for children with Autism, ADHD, sensory challenges, physical disabilities, and more. Our goal is to help our special needs students build water confidence, improve fitness and learn essential water safety skills.',
  descriptionsBottom: [
