...
const generateSellingPointsSectionData = (options: { cityName: string }): SellingPointsSectionType => ({
  ...
  sectionDescription: `Many ${options.cityName} parents wonder if their baby is too young to start learning to swim. They think babies will eventually learn the skills on their own, or that the skill isn’t necessary. Here’s why starting lessons early is a smart choice:`,
  image: localBabyFiveReasonsToStart,
  sellingReasons: [
    {
      title: 'Water safety starts early',
      description: 'Drowning is the leading cause of accidental death for children under four. Babies are naturally curious, which is why baby swimming lessons make so much sense. An awareness of the water, and water safety skills, could very well save your child’s life one day.',
