...
const generateGeneralFirstSectionData = (options: { cityName: string }): GeneralFirstSectionType => ({
  heading1: `Swim instructor jobs in ${options.cityName} available: Apply now`,
  media: swimInstructorJobsInCityImg,
  buttonText: 'Apply Now',
  buttonLink: '#',
  descriptionTop: `Join Sunsational Swim School, America’s #1 provider of mobile swim lessons. We’re currently partnering with swim instructors in ${options.cityName} for Spring/Summer 2025 and beyond!`,
  descriptionsBottom: [
