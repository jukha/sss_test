        ...
        <div>
          <label className='flex gap-2 items-center relative'>
            <input
              ...
              onChange={(e) => setIsCurrentUserParentOrGuard(e.target.checked)}
              className='invisible w-0 h-0 absolute'
            />
            <CustomCheckbox checked={isCurrentUserParentOrGuard} />
            <span className='font-medium'>I am the parent/guardian</span>
          </label>
        </div>
      </div>
