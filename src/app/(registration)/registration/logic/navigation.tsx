...
const nextSteps = {
  ...
  [RegistrationStepEnum.Step3]: RegistrationStepEnum.Step4,
  [RegistrationStepEnum.Step4]: RegistrationStepEnum.Step5,
...
const previousSteps = {
  ...
  [RegistrationStepEnum.Step4]: RegistrationStepEnum.Step3,
  [RegistrationStepEnum.Step5]: RegistrationStepEnum.Step4,
...
export const circleNavigationBarSteps = [
  { image: registrationStep1, steps: [RegistrationStepEnum.Step1, RegistrationStepEnum.Step1Success, RegistrationStepEnum.Step1NoPoolsError, RegistrationStepEnum.Step1OutsideAreaError] },
  { image: registrationStep2, steps: [RegistrationStepEnum.Step2] },
  { image: registrationStep3, steps: [RegistrationStepEnum.Step3] },
  { image: registrationStep4, steps: [RegistrationStepEnum.Step4] },
