...
const OrderConfirmed: React.FC = () => {
  ...
  const { email, zip } = registrationForm ?? {};
  ...
  const isHighDemandMetroArea = (metroArea && metroArea.matchRate30Day) ? metroArea.matchRate30Day <= 0.3 : false;
