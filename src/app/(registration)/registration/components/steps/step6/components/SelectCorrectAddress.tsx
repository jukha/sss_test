  ...
  return (
    <div className='leading-[1.2]'>
      ...
      <p className='text-sm mb-2'>
        We found a more precise version of the address you entered. If it looks
        right, please use the suggested address to make sure we find the best
        swim instructor for your lessons.
      </p>
      <div className='flex items-start gap-4'>
        <div>
          <div className='font-medium text-lg leading-[1.2]'>
            Address entered
          </div>
        ...
        <div>
          ...
          <label className='flex items-start gap-2 font-medium mt-2'>
            ...
            />
            <span className='text-lg'>{suggestedAddress}</span>
          </label>
        </div>
      </div>
    </div>
