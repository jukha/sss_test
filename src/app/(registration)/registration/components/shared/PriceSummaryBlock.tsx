...
const PriceSummaryBlock: React.FC<Props> = ({
  ...
  return (
    <div
      className={clsx(
        'font-primary leading-[1.2] pb-2.5 text-offBlack desktop:pb-4',
        className
      )}
    >
      <div className='font-semibold uppercase text-[14px] desktop:text-[20px]'>
        {title}
      </div>
      <div
        className={clsx(
      ...
      <div className='flex items-center'>
        <div className='text-[10px] font-medium text-[#422019] desktop:text-[14px]'>
          {countingStr}
        </div>
        {countingStrSalePercent && (
