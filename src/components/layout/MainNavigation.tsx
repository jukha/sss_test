...
import { HamburgerIcon, WaveWithBorder, ChevronDown, ChevronUp } from '../icons';
      ...
      {isMobileMenuOpen && (
        <div className='md:hidden flex flex-col gap-4 relative text-[#110241] font-bold text-xl px-[16%] py-2 space-y-2 font-[Grandstander]'>
          ...
          <div>
            ...
            >
              Swim Lesson Programs {isMobileLessonsOpen ? <ChevronUp /> : <ChevronDown />}
            </button>
            {isMobileLessonsOpen && (
        ...
        <div className='flex   items-center gap-8 justify-center w-full '>
          ...
          <div ref={lessonsMenuRef} className='flex flex-col gap-6'>
            ...
            {isLessonsMenuOpen && (
              ...
              >
                <Link href='/private-swim-lessons' className='hover:text-orange'>
                  Private Swim Lessons
                </Link>
                <Link href='/baby-swim-lessons' className='hover:text-orange'>
                  Baby Swim Lessons
                </Link>
                <Link href='/toddler-swim-lessons' className='hover:text-orange'>
                  Toddler Swim Lessons
                </Link>
                ...
                <Link href='/special-needs-swim-lessons' className='hover:text-orange'>
                  Special Needs Swim Lessons
                </Link>
              </div>
            )}
